...
const PaymentOutFormPopup = ({ isOpen, onClose, projectName, projectId, clientName, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(error.message || 'Failed to save payment out');
        } finally {
            setSubmitting(false);
        }
    };
    ...
    const inputStyle = "w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm font-medium focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all";
                ...
                <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl flex flex-col">
                    ...
                    <div className="px-6 py-4 bg-white border-b border-gray-100 flex items-center justify-between sticky top-0 z-10">
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-xl font-bold text-gray-900 tracking-tight" style={{ fontFamily: 'var(--font-family)' }}>Record Payment Out</h2>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-rose-500 font-bold">
                                            ₹
                                        </div>
                                        <input
                                            type="number"
                                            ...
                                            className={`${inputStyle} pl-8 text-lg font-bold text-rose-600`}
                                            placeholder="0.00"
                                            style={{ fontFamily: 'var(--font-family)' }}
                                        />
                                    </div>
                                            ...
                                            `}>
                                                ...
                                                <div className={`
                                                    ...
                                                    ${formData.paymentMethod === method
                                                        ? 'bg-rose-50 text-rose-600 border-rose-200 shadow-sm ring-1 ring-rose-100'
                    ...
                    <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex items-center justify-end gap-3">
                        ...
                        <button
                            ...
                            disabled={submitting}
                            className="px-6 py-2.5 rounded-xl text-sm font-bold text-white bg-rose-600 hover:bg-rose-700 shadow-lg shadow-rose-200 transition-all flex items-center gap-2"
                            style={{ fontFamily: 'var(--font-family)' }}
                        >
                            {submitting ? <FiLoader className="animate-spin" /> : <><FiCheck /> CONFIRM PAYMENT</>}
                        </button>
                    </div>
                </div>
            </div>
